...
formatting, and security checks on every commit.
...
This will configure git to automatically run the configured hooks
(ruff, gitleaks, trailing-whitespace, etc.) before each commit.
